...
const Hero = () => {
  ...
  return (
    <section
      className="relative h-[calc(100vh-80px)] lg:h-[calc(100vh-96px)] overflow-hidden"
      style={{ isolation: 'isolate' }}
    >
      {/* Main content */}
      <div className="relative z-50 w-full max-w-7xl mx-auto px-6 lg:px-8 h-full">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-6 lg:gap-10 h-full pt-20 lg:pt-28">
          {/* 👆 pt increased → text + model neeche aa gaye */}

          {/* LEFT */}
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-3 flex-1 lg:w-1/2">
            <h1
            ...
            <p className="text-white text-lg md:text-xl select-text">
          ...
          <div
            ...
            className="relative w-full lg:w-1/2 max-w-md mx-auto flex items-center justify-center pointer-events-none
