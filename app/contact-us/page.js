    ...
    <main className="text-white relative">
      ...
      <section className="relative w-full py-8 lg:py-12">
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-8">
          <div className="w-full rounded-full bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-sky-900/20 backdrop-blur-2xl border border-white/10 shadow-2xl py-3 lg:py-4 px-6 lg:px-8">
            <div className="flex flex-row items-center justify-around gap-4 lg:gap-8">
              {/* Email Contact */}
              <div className="flex flex-row items-center gap-3">
                ...
                <a href="mailto:info@logisol.tech" className="text-white text-sm lg:text-base underline hover:text-cyan-400 transition-colors whitespace-nowrap">
                  info@logisol.tech
                </a>
              </div>
              ...
              <div className="flex flex-row items-center gap-3">
                ...
                <a href="tel:+16266716483" className="text-white text-sm lg:text-base underline hover:text-cyan-400 transition-colors whitespace-nowrap">
                  (626)-671-6483
                </a>
              </div>
              ...
              <div className="flex flex-row items-center gap-3">
                ...
                <a href="https://maps.google.com/?q=1001+S+Main+St+Kalispell+Montana+USA" target="_blank" rel="noopener noreferrer" className="text-white text-sm lg:text-base underline hover:text-cyan-400 transition-colors whitespace-nowrap">
