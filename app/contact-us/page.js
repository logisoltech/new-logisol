          ...
          <div className="w-full rounded-full bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-sky-900/20 backdrop-blur-2xl border border-white/10 shadow-2xl py-3 lg:py-4 px-6 lg:px-8">
            <div className="flex flex-row items-center justify-around gap-4 lg:gap-8">
              ...
              <div className="flex flex-row items-center gap-3">
                ...
                <a href={`mailto:${contact.email}`} className="text-white text-sm lg:text-base underline hover:text-cyan-400 transition-colors whitespace-nowrap">
                  {contact.email}
                </a>
              </div>
              ...
              <div className="flex flex-row items-center gap-3">
                ...
                <a href={contact.phoneLink} className="text-white text-sm lg:text-base underline hover:text-cyan-400 transition-colors whitespace-nowrap">
                  {contact.phone}
                </a>
              </div>
              ...
              <div className="flex flex-row items-center gap-3">
                ...
                <a href={contact.addressLink} target="_blank" rel="noopener noreferrer" className="text-white text-sm lg:text-base underline hover:text-cyan-400 transition-colors whitespace-nowrap">
                  {contact.address}
                </a>
              </div>
            </div>
