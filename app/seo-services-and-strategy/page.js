...
const Page = () => {
  ...
  const paragraphs = [
    {
      heading: 'Strategic SEO That Drives Organic Growth',
      text: (
        <>
          At <span className="text-cyan-400 font-semibold">Logisol Technologies</span>, we develop
          comprehensive SEO strategies that improve your search engine rankings and drive organic traffic.
          Our data-driven approach ensures sustainable growth for your business.
        </>
      ),
    },
    {
      heading: 'Technical SEO & On-Page Optimization',
      text: (
        <>
          We optimize your website&apos;s technical foundation, content structure, and on-page elements.
          From keyword research to schema markup, we ensure every aspect of your site is optimized
          for search engines.
        </>
      ),
    },
    {
      ...
      text: (
        <>
          Our SEO services include content creation, link building, and authority development. We create
          high-quality content that attracts backlinks and establishes your brand as an industry leader.
        </>
      ),
    },
    {
      heading: 'Measurable Results, Transparent Reporting',
      text: (
        <>
          Partner with us to achieve higher rankings and increased organic visibility. Let&apos;s build
          an SEO strategy that delivers measurable results and long-term growth for your business.
        </>
      ),
    },
  ];
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-12 xl:gap-16">
              ...
              <div ref={rightAreaRef} className="hidden lg:block relative w-full lg:w-1/2">
                <div
                  id="seo-services-model-container"
