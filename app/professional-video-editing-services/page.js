...
const Page = () => {
  ...
  const paragraphs = [
    {
      heading: 'Professional Video Editing That Tells Your Story',
      text: (
        <>
          At <span className="text-cyan-400 font-semibold">Logisol Technologies</span>, we transform
          raw footage into compelling visual narratives. Our expert editors combine technical skills
          with creative vision to produce videos that captivate and engage your audience.
        </>
      ),
    },
    {
      heading: 'From Raw Footage to Polished Productions',
      text: (
        <>
          We handle everything from color grading and audio mixing to motion graphics and special effects.
          Our video editing services ensure your content looks professional and delivers maximum impact
          across all platforms.
        </>
      ),
    },
    {
      heading: 'Multi-Format Delivery for Every Platform',
      text: (
        <>
          Our video editing services include format optimization for web, social media, and broadcast.
          We create videos that perform perfectly on YouTube, Instagram, TikTok, and other platforms,
          ensuring your content reaches its full potential.
        </>
      ),
    },
    {
      heading: 'Bring Your Vision to Life, Frame by Frame',
      text: (
        <>
          Partner with us to create videos that resonate with your audience and drive engagement.
          Let&apos;s turn your ideas into stunning visual content that makes a lasting impression.
        </>
      ),
    },
  ];
  ...
  return (
    <main className="text-white relative">
      ...
      <div className="flex flex-col items-center justify-center h-[20rem] sm:h-[25rem] lg:h-[30rem] px-4">
        ...
        >
          VIDEO <span className="text-cyan-400">EDITING</span> SERVICES
        </h1>
...
{/* <div
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-12 xl:gap-16">
              ...
              <div ref={rightAreaRef} className="hidden lg:block relative w-full lg:w-1/2">
                <div
                  id="video-editing-model-container"
      ...
      <Portfolio defaultTab="Video Editing" />
      <CaseStudy />
